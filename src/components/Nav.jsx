      ...
      <div className="container">
        ...
        <div id="navbarBasicExample" className="navbar-menu">
          <div className="navbar-start">
            ...
            <Link to="/allteam" className="navbar-item">
              <img
                src="https://www.score108.com/image/flag/none/soccer-tournament.png"
                alt="Football News"
                className="has-text-white hover:has-text-grey-lighter transition duration-300 font-bold text-sm"
                style={{ width: '40px', height: '40px' }}
              />
            </Link>
            <Link to="/Standings" className="navbar-item">
              <img
                src="https://thaileague.poakpong.com/sites/default/files/logo-thaileague.png"
                alt="crudFootball News"
                className="has-text-white hover:has-text-grey-lighter transition duration-300 font-bold text-sm"
                style={{ width: '40px', height: '40px' }}
              />
            </Link>
            <Link to="/Topscores" className="navbar-item">
              <img
                src="https://cdn.iconscout.com/icon/premium/png-256-thumb/best-player-award-2688419-2228454.png"
                alt="crudFootball News"
                className="has-text-white hover:has-text-grey-lighter transition duration-300 font-bold text-sm"
                style={{ width: '40px', height: '40px' }}
              />
